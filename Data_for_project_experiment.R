...
# sort by region
medelålder <- arrange(medelålder_kommun, region)


### Steo 3: Synthesize the necessary data to project
# add to average age of population to dataframe total_död
data <- cbind(total_död, medelålder$`Befolkningens medelålder`)
colnames(data)= c("Region","Dödfall","Medelålder")
